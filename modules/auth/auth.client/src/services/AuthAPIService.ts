...
import type { LoginRequest, LoginResponse, RegisterRequest, RegisterResponse, UserProfileResponse } from 'shared';
import { AuthRoutes, createAuthApiClient } from 'shared';
