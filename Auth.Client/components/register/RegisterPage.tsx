          ...
          <div className="flex flex-col items-center text-center space-y-6 my-auto justify-center flex-1">
            ...
            <div className="space-y-2 max-w-[240px]">
              ...
              <p className="text-slate-500 text-xs leading-relaxed">
                Join our admin panel to manage orders, products, and messages in a single responsive workspace.
              </p>
            </div>
          </div>
        ...
        <div className="col-span-1 md:col-span-7 flex flex-col justify-center p-8 md:p-12 bg-white relative">
          ...
          <div className="w-full max-w-md mx-auto space-y-6">
            <div className="space-y-2">
              ...
              <p className="text-slate-500 text-sm">Register a new administrator profile to get started.</p>
            </div>
